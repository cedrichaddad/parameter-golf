...
- Trace index: `records/wind_tunnel/reviewer_report/trace_index.json`
- Corpus: `records/wind_tunnel/reviewer_report/trace_corpus.json`
- Calibration: `records/wind_tunnel/reviewer_report/calibration_model.json`
- Scenario: `records/wind_tunnel/reviewer_report/scenario_exact_recurrent_replay.json`
- Suite summary: `records/wind_tunnel/reviewer_report/suite/summary.json`
- JSON report: `records/wind_tunnel/reviewer_report/report.json`
